...
function FullTableClient(props) {
            ...
            {(rowsPerPage > 0
              ...
              <StyledTableRow className="row" key={row.name}>
                ...
                <StyledTableCell className="line"  >
                  ...
                  <i className="material-icons" onClick={() => setEditPopupclient(true)} >border_color</i>
                  <div className="popeditfleet"> 
                  <PopupEditClient trigger={editPopupclient} setTrigger={setEditPopupclient}/>
                  </div>
...
export default FullTableClient