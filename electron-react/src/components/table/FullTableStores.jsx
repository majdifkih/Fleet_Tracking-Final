            ...
            {(rowsPerPage > 0
              ...
              <StyledTableRow className="row" key={row.name}>
                ...
                <StyledTableCell className="line"  >
                  ...
                  <i className="material-icons" onClick={() => setEditPopupstore(true)} >border_color</i>
                  <div className="popeditfleet"> 
                  <PopupEditStore trigger={editPopupstore} setTrigger={setEditPopupstore}/>
                  </div>
                  <i class="material-icons">info_outline</i>
                  <Link to="/store" ><i class="material-icons">pin_drop</i></Link>
                  </div>
